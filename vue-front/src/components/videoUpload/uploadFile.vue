...
<!-- https://blog.csdn.net/outlierQiqi/article/details/106538216?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522164995174816782089346452%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=164995174816782089346452&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~baidu_landing_v2~default-1-106538216.142^v8^control,157^v4^control&utm_term=vue-simple-uploader%E7%9A%84%E5%8F%82%E6%95%B0&spm=1018.2226.3001.4187 -->
    <div>
        ...
        <uploader ref="uploader" v-loading="loading" element-loading-text="正在合成视频文件，请稍等~" :options="options" :autoStart=false :file-status-text="fileStatusText"
            @file-added="onFileAdded" @file-success="onFileSuccess" @file-progress="onFileProgress"
            @file-error="onFileError" @file-removed="fileRemoved" class="uploader-ui">
    ...
    methods: {
        ...
        */
        onFileSuccess(rootFile, file, response, chunk) {
            console.log({'success-rootFile: ': rootFile, 'success-file: ': file, 'success-response: ': response, 'success-chunk: ': chunk})
        ...
        onFileError(rootFile, file, response, chunk) {
            ...
            console.log({ 'error-rootFile: ': rootFile, 'error-file: ': file, 'error-response: ': response, 'error-chunk: ': chunk })
        },
        // 将所选文件删掉后
        fileRemoved() {
