      ...
      <div>
        <p style="color: #606266">
          ...
          <svg class="icon" aria-hidden="true" @click="collectInit">
            <use
              v-if="videoData.isCollectClick"
              xlink:href="#icon-shoucang1"
            ></use>
            <use v-else xlink:href="#icon-shoucang"></use>
          </svg>
          {{ videoData.collectNum }}
        </p>
        <!-- 笔记 -->
        <div>
          <!-- 记笔记按钮 -->
            ...
            <el-dialog :visible.sync="outerVisible" title="开始记录你的笔记吧~">
              ...
              >
                ...
                <span class="dialog-footer" slot="footer">
                  ...
                  <el-button @click="setNewNoteLabel" type="primary"
                    >确 定</el-button
                  >
                </span>
              </el-dialog>
              <div>
                ...
                <el-button @click="innerVisible = true" type="primary"
                  >新建标签</el-button
                >
                <el-input
                  :rows="10"
        ...
        <div>
          ...
          <div v-if="outerVisibleCollect">
            <el-dialog :visible.sync="outerVisibleCollect" title="添加到收藏夹">
              <el-dialog
              ...
              >
                ...
                ></el-input>
                <span class="dialog-footer" slot="footer">
                  <el-button @click="innerVisibleCollect = false"
                    >取 消</el-button
                  >
                  <el-button @click="setNewCollectLabel" type="primary"
                    >确 定</el-button
                  >
                </span>
              </el-dialog>
              <div>
                ...
                <el-button @click="innerVisibleCollect = true" type="primary"
                  >新建收藏夹</el-button
                >
              </div>
              <div class="dialog-footer" slot="footer">
                <el-button @click="outerVisibleCollect = false"
                  >取 消</el-button
                >
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      this.fullscreenLoading = true;
      this.$axios
        .get("/video/getVideo?videoId=" + this.$route.query.videoDataId)
        .then((response) => {
